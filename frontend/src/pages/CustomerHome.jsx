    ...
    return (
      <div className="bg-paper min-h-screen flex items-center justify-center p-4 font-body">
        <div className="bg-paper-card border border-ink/10 rounded-[2rem] p-8 sm:p-10 max-w-sm w-full text-center">
          ...
          <h1 className="text-3xl font-display font-semibold text-ink mb-2">Find your next chair</h1>
          <p className="text-ink/50 text-sm mb-8 leading-relaxed font-body">
            Book instantly, skip the wait. See live queue times at salons near you.
          </p>
          <div className="bg-paper-card border border-ink/15 rounded-2xl p-4 mb-8 text-left space-y-3">
            <div className="flex items-start gap-3">
              <MapPin size={17} className="text-rose flex-shrink-0 mt-0.5" />
              <p className="text-sm text-ink/70">Show salons within <strong className="text-ink">5 km</strong> of you</p>
            </div>
            <div className="flex items-start gap-3">
              <Clock size={17} className="text-rose flex-shrink-0 mt-0.5" />
              <p className="text-sm text-ink/70">Show <strong className="text-ink">live wait times</strong> for each salon</p>
            </div>
            <div className="flex items-start gap-3">
              <Wifi size={17} className="text-rose flex-shrink-0 mt-0.5" />
              <p className="text-sm text-ink/70">Your location is <strong className="text-ink">never stored</strong> on our servers</p>
            </div>
          </div>
          <button
    ...
    return (
      <div className="bg-paper min-h-screen flex items-center justify-center font-body">
        <div className="text-center px-4">
          ...
          <p className="text-lg font-semibold text-ink/70 font-display">
            {locationState === LOCATION_STATE.ASKING
    ...
    <div className="bg-paper min-h-screen font-body">
      <div className="max-w-6xl mx-auto px-4 pt-8 sm:pt-12 pb-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl sm:text-5xl font-display font-semibold text-ink mb-2 sm:mb-3 leading-tight">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-2 gap-y-1 mt-4">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs text-ink/50 hover:text-ink font-semibold transition"
            >
              <RefreshCw size={11} />
              Refresh
            </button>
        ...
        <div className="bg-paper-card border border-ink/10 rounded-2xl sm:rounded-3xl p-5 sm:p-6 mb-6">
          <div className="relative">
            ...
            <input
              ...
              className="bg-paper-card border border-ink/15 w-full pl-11 pr-4 py-3.5 rounded-xl focus:border-rose/60 focus:outline-none transition text-sm text-ink placeholder:text-ink/35"
            />
          </div>
        </div>
        ...
        {loading ? (
          <div className="text-center py-20">
            ...
            <div className="text-lg font-semibold text-ink/50 font-display">Searching for salons…</div>
          </div>
        ) : filteredSalons.length === 0 ? (
          <div className="text-center py-20">
            <MapPin size={56} className="mx-auto text-ink/20 mb-4" />
            <div className="text-2xl font-display font-semibold text-ink/60 mb-2">No salons found</div>
            <p className="text-ink/40 mb-6">Try increasing the search radius</p>
            <button
              ...
              >
                ...
                <div className="w-24 sm:w-32 md:w-40 flex-shrink-0 bg-gradient-to-br from-rose/40 to-ink relative overflow-hidden flex items-center justify-center">
                  {salon.coverImage
                    ...
                    : (
                      <span className="text-2xl sm:text-4xl md:text-5xl font-display font-semibold text-ink/90">
                        {salon.name.charAt(0)}
                      </span>
                    )
                  }
                ...
                <div className="flex-1 min-w-0 p-3 sm:p-5 flex flex-col justify-between">
                  <div className="min-w-0">
                    ...
                    <div className="flex items-center flex-wrap gap-x-2.5 gap-y-1 sm:gap-x-4">
                      ...
                      <div className="w-px h-3.5 bg-ink/15 flex-shrink-0" />
                  ...
                  <div className="border-t border-ink/10 mt-2 pt-2 sm:pt-3 flex justify-end">
